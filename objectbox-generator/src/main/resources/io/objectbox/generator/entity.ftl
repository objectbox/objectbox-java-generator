...
// THIS CODE IS GENERATED BY ObjectBox, EDIT ONLY INSIDE THE "KEEP"-SECTIONS
...
<#if property.converter??>
    @Convert(converter = ${property.converter}.class, dbType = ${property.javaType}.class)
</#if>
<#if notNull>
    @NotNull
</#if>
